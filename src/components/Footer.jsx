...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#fbfbfa] border-t border-slate-200 py-16 relative overflow-hidden z-10 text-slate-600">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
          ...
          <div className="md:col-span-4 space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-lg font-bold tracking-wider font-display text-slate-900">
                NEUROLUME
              </span>
            </div>
          ...
          <div className="md:col-span-4 space-y-3">
            <h4 className="text-xs uppercase tracking-widest font-bold text-slate-900 font-display">
              {t('footer.manufacturedBy')}
            </h4>
            <div className="text-xs space-y-1">
              <p className="font-bold text-slate-800">Surya Herbal Limited</p>
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <div className="text-xs space-y-1">
              <p className="font-bold text-slate-800">Isshaan Healthcare Pvt Ltd</p>
        ...
        <div className="pt-8 border-t border-slate-200 space-y-4">
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 text-[10px] sm:text-xs leading-relaxed text-slate-500">
            <strong className="text-slate-800">{t('footer.disclaimerTitle')}</strong> {t('footer.disclaimer')}
          </div>
